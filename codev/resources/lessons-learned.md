...
Generalizable wisdom extracted from review documents. Updated during MAINTAIN protocol runs.

> **Note**: Items codified as rules (CLAUDE.md invariants, protocol requirements) are not repeated here. This file captures insights that inform future decisions but aren't strict rules.
